function ej1() {
    document.getElementById("r1").innerHTML = formatearNombre("maIcA");
}

function ej2() {
    document.getElementById("r2").innerHTML =  contarLetras("hola mundo");
}

function ej3() {
    document.getElementById("r3").innerHTML =  maximo(5, 9, 3);
}

function ej4() {
    document.getElementById("r4").innerHTML =  validarPassword("abc12345");
}

function ej5() {
    document.getElementById("r5").innerHTML = sumarArray([1, 2, 3, 4]);
}

function ej6() {
    document.getElementById("r6").innerHTML =  mayorNumero([3, 7, 2, 10]);
}

function ej7() {
    document.getElementById("r7").innerHTML = obtenerPares([1, 2, 3, 4, 5, 6]);
}
...
function ej8() {
    document.getElementById("r8").innerHTML =  descripcionUsuario(usuario);
}

function ej9() {
    let resultado = activarUsuario(usuario);
    document.getElementById("r9").innerHTML =  resultado.activo;
}
...
function ej10() {
    ...
    document.getElementById("r10").innerHTML =  precioTotal(productos);
}
...
function ej14() {
    document.getElementById("r14").innerHTML =  desestructurar(producto);
}

function ej15() {
    let copia = copiaProducto(producto);
    document.getElementById("r15").innerHTML = copia.nombre + " - " + copia.precio + " - stock: " + copia.stock;
}
...
function ej16() {
    ...
    if (prod == null) {
        ...
        document.getElementById("r16").innerHTML = prod.nombre + " - " + prod.precio;
    }
}
...
function ej20() {
    ...
    if (usuario == null) {
        ...
        document.getElementById("r20").innerHTML = usuario.id + " - " + usuario.nombre + " - " + usuario.edad;
    }
}
